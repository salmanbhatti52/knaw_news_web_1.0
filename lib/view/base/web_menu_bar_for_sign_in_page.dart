...
class WebMenuBarSignIn extends StatefulWidget implements PreferredSizeWidget {
  int index;
  ...
  WebMenuBarSignIn(
      ...
      this.isHalf = false});
  @override
  State<WebMenuBarSignIn> createState() => _WebMenuBarSignInState();
...
class _WebMenuBarSignInState extends State<WebMenuBarSignIn> {
  ...
  void initState() {
    ...
    if (widget.index == 1)
      ...
      isActiveFav = true;
    else if (widget.index == 4) isActiveContact = true;
  ...
  Widget build(BuildContext context) {
    ...
    double mediaWidth = size.width < 1000
        ? size.width
        : widget.isHalf
            ? size.width * 0.5
            : size.width * 0.7;
                  ...
                  : isSearch
                      ? Center(
                          child: SizedBox(
                            ...
                            child: InkWell(
                              onTap: () =>
                                  searchText ? null : Get.toNamed("/WebSearch"),
                              child: Row(
                                children: [
                                  Expanded(
                                    child: SearchField(
                            ...
                            ? InkWell(
                                ...
                                child: Stack(
                                  children: [
                                    ...
                                    AppData().userdetail!.userVerified
                                        ? Positioned(
                                            bottom: 0,
                                            right: 0,
