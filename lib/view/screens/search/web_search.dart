...
class _WebSearchState extends State<WebSearch> {
  ...
  Widget build(BuildContext context) {
    ...
    mediaWidth>1000?mediaWidth/=2:mediaWidth/=1.5;
    return WillPopScope(
      onWillPop: () async {
        return true;
      },
      child: Scaffold(
        ...
        appBar: WebMenuBar(context: context,isAuthenticated: true,searchText: true,onTap: (val){
          isShow=false;
          if(val==""){
            isSearch=false;
            titleFilter = val;
        ...
        body: Center(
          child: Row(
            ...
            children: [
              Container(
                color: Colors.white,
                width: mediaWidth<400?mediaWidth*0.75:mediaWidth*0.48,
                margin: EdgeInsets.only(right: 15,top: 10),
                child: WebSearchFilter(
                  tag: tagFilter,
              ...
              Container(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(children: [
                    ...
                    isShow?FullTransition(postDetail: isSearch?postDetail![ind]:recentDetail![ind].postDetail,):
